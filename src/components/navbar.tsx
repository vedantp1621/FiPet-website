...
{mobileOpen && (
  ...
  <div className="  flex flex-col px-6 py-4 space-y-4 text-purple-700 text-[16px] capitalize  rounded-xl z-40 shadow-[inset_0_-4px_12px_#ffffff8c,_inset_0_8px_13px_#ffffffbf] backdrop-blur-[34px]">
    <Link href="/" onClick={() => setMobileOpen(false)}>Discover</Link>
    <Link href="/about" onClick={() => setMobileOpen(false)}>About</Link>
    <Link href="/services" onClick={() => setMobileOpen(false)}>Team</Link>
